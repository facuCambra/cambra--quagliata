...
Actor: Persona , Admin local recreativo

Descripción: el Sistema permite a un usuario crear un evento. Si es dueño de un local se le permite crear un evento relacionado al mismo. Si es una persona solo podrá crear actividades a locales de otros dueños, casas particulares o lugares públicos.
